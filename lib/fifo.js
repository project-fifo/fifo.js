...
var token_reuse_limit = 80;
var token_reuse_count = 0;
...
function handleError(err, req, res)
{
    ...
    // console.trace(err);
    if ((err.code == 'ECONNRESET') || (err.statusCode == 404) || (err.statusCode == 500) || (err.statusCode == 503) || (err.code == 'EMFILE'))
        deferred.resolve([]);
    else
